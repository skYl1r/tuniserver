...
public class JwtValidator {
    ...
    private static final List<String> allowedIsses = Collections.singletonList("http://localhost:8090/auth/realms/sesame");
    ...
    public DecodedJWT validate(String token) {
        try {
        	token = RegExUtils.removeFirst(token, "Bearer ");
